...
class DBM():
    ...
    def treadate(self, key, value):
        ...
        self.c += 1
        print('\t\t\tUpdating db %s/%s updates finished'%(self.c, tots), end='\r')
    ...
    def update(self, dc):
        ...
        with DB(self, self.db):
            for key, value in dc.items():
                threads += [threading.Thread(target=self.treadate, args=(key,value))] #some shit
